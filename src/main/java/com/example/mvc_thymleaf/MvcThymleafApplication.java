      ...
      @Bean
        ...
        return args->{
            patientRepository.save(
                    new Patient( null,"Hassan", new Date(),  false));
            patientRepository.save(
                    new Patient(  null, "Mohammed", new Date(),  true));
            patientRepository.save(
                    new Patient( null,"Yasmine", new Date(),  false ));
            patientRepository.save(
                    new Patient(  null, "Hanae", new Date(),  false ));
